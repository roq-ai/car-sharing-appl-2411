  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of transportation with Car Sharing Application - a platform designed to make car sharing seamless, efficient, and convenient."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of transportation with Car Sharing Application - a platform designed to make car sharing seamless, efficient, and convenient.`}
            </Text>
            <Box
